package beyond; /******************************************************************************
 *  Compilation:  javac beyond.Draw.java
 *  Execution:    java beyond.Draw
 *  Dependencies: none
 *
...
/**
 *  <i>beyond.Draw</i>. This class provides a basic capability for
...
public final class Draw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    // name of window
    private String name = "beyond.Draw";
    ...
    ***************************************************************************/
     ...
     *
     * @param listener the {\tt beyond.DrawListener} argument
     */
